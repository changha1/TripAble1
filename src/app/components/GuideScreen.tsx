...
const GUIDE_SECTIONS = [
  {
    id: '1',
    title: '🎯 TripAble이란?',
    content: `TripAble은 문화누리카드, 한국관광공사 여행이용권 등 복지 바우처를 보유한 분들이 쉽고 빠르게 이용 가능한 관광시설을 찾을 수 있도록 돕는 맞춤 여행 서비스입니다.
...
• 여행 계획 저장 및 공유`,
  },
  {
    id: '2',
    title: '💳 지원 바우처 종류',
    content: `현재 TripAble에서 지원하는 바우처 종류입니다.

① 문화누리카드
기초생활수급자·차상위계층을 위한 문화·여행·체육 지원 바우처
연간 최대 130,000원 지원

② 한국관광공사 여행이용권
저소득층 여행 지원을 위한 국민행복카드 연계 바우처
연간 최대 100,000원 지원

③ 관광두레 이용권
지역 주민 주도의 관광사업체 체험 지원 바우처
최대 50,000원 지원

④ 여가바우처
장애인 여가활동 지원 바우처 (장애인활동지원)
최대 80,000원 지원`,
  },
  {
    id: '3',
